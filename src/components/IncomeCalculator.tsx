          ...
          <CardContent className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                ...
                <Badge variant="secondary" className="text-base md:text-lg px-8 md:px-10 py-2 md:py-3 bg-[#FFD700] text-slate-900 hover:bg-[#FFD700] font-bold">{hoursPerDay[0]} ч</Badge>
              </div>
              <Slider
                value={hoursPerDay}
