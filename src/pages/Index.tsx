            ...
            {[
              {
                ...
                text: 'Работаю 3 месяца, очень доволен! Зарабатываю около 120 000 ₽ в месяц. График гибкий, могу совмещать с учёбой.',
                rating: 5
              },
              {
                name: 'Мария',
                role: 'Автокурьер, Санкт-Петербург',
                text: 'Работаю уже 6 месяцев, зарабатываю стабильно 140 000 ₽. Отличный вариант для подработки! Выплаты всегда вовремя.',
                rating: 5
              },
              {
                name: 'Дмитрий',
                role: 'Пеший курьер, Казань',
                text: 'Начал работать 2 месяца назад, делаю около 85 000 ₽. Удобно работать в своём районе, не нужно далеко ехать.',
                rating: 5
              },
              {
                name: 'Елена',
                role: 'Велокурьер, Екатеринбург',
                text: 'Работаю 4 месяца, зарабатываю примерно 105 000 ₽ в месяц. Поддержка реально помогает, если что-то непонятно.',
                rating: 5
              }
            ].map((review, index) => (
              <Card key={index} className="border shadow-md">
